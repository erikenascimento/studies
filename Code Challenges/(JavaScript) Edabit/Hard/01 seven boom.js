...
function sevenBoom(arr) {
	const asString = arr.toString(); //will convert the array of number to string in order to check if the number 7 is present.
	//keeping the array as an array of number would only look for the number 7 isolated in it.
	return arr = (asString.includes("7")) ? "Boom!" : "there is no 7 in the array";
}
