...
import imagemMassa1 from "assets/sobre/massa1.png";
import imagemMassa2 from "assets/sobre/massa2.png";
import imagemCasa from "assets/sobre/casa.png";

const imagens = [imagemMassa1, imagemMassa2];
	...
	return (
		<section>
			...
			<div className={styles.sobreNos}>
				<img src={imagemCasa} alt="Casa Aluroni" />
